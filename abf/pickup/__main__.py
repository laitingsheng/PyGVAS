...
real_saves = dict[str, ABFWorldSave]()
...
if picked_items:
    ...
    save = real_saves.pop("Facility")
    deployed_objects_map = save.body.get("DeployedObjectMap")
    ...
    save.to_binary_file(output_folder / "WorldSave_Facility.sav")
